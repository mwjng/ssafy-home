...
public enum ErrorCode {
    ...
    INVALID_OAUTH_PROVIDER(2006, UNAUTHORIZED, "지원하지 않는 OAuth 제공자 입니다."),
    EXPIRED_ACCESS_TOKEN(2007, UNAUTHORIZED, "만료된 AccessToken 입니다."),
    EXPIRED_REFRESH_TOKEN(2008, UNAUTHORIZED, "만료된 RefreshToken 입니다."),
    INVALID_MEMBER_ROLE(2009, UNAUTHORIZED, "유효하지 않은 권한 정보 입니다."),
    FAIL_OAUTH_USERINFO_RETRIEVAL(2010, UNAUTHORIZED, "회원 정보를 가져오는데 실패했습니다."),
