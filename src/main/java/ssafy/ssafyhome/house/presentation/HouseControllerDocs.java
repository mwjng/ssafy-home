...
public interface HouseControllerDocs {
    ...
    @GetMapping
    ResponseEntity<HousesResponse> searchAll(@Parameter(name = "검색 조건") final HouseSearchCondition houseSearchCondition);
    ...
    ResponseEntity<HouseResponse> search(
            ...
            @Parameter(name = "검색 조건") final HouseSearchCondition houseSearchCondition
    );
    ...
    ResponseEntity<Void> create(
            ...
            @Parameter(name = "house") final HouseCreateRequest houseCreateRequest,
